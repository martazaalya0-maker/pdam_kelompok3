...
CREATE TABLE `pelanggan` (
  ...
  `golongan` enum('Rumah Tangga','Industri','instansi pemerintah') NOT NULL,
...
(3, 'Farisy Ahmad Assyidiqi', NULL, 'Industri', '08239219043', '2026-06-08'),
(4, 'willy', NULL, '', '082375812', '2026-06-08'),
(5, 'koko', NULL, 'instansi pemerintah', '0824623952', '2026-06-08');
...
INSERT INTO `pemakaian` (`id_pemakaian`, `id_pelanggan`, `id_user`, `bulan`, `tahun`, `meter_awal`, `meter_akhir`, `tanggal_catat`) VALUES
(1, 2, NULL, NULL, NULL, 0, 0, '2026-06-08'),
(2, 1, NULL, NULL, NULL, 0, 0, '2026-06-08'),
(3, 2, NULL, NULL, NULL, 0, 0, '2026-06-08');
...
(1, NULL, 1, 11, 108000.00, 'lunas', '2026-06-06 00:00:00'),
(2, NULL, 2, 12, 116000.00, 'lunas', '2026-06-06 00:00:00'),
(3, NULL, 1, 15, 140000.00, 'lunas', NULL),
(4, NULL, 1, 12, 116000.00, 'lunas', NULL),
(5, NULL, 2, 12, 116000.00, 'lunas', '2026-06-08 17:13:00'),
(6, NULL, 2, 13, 124000.00, 'lunas', '2026-06-08 17:15:28'),
(7, NULL, 1, 25, 220000.00, 'lunas', '2026-06-08 17:26:54'),
(8, NULL, 2, 54, 263000.00, 'lunas', '2026-06-08 17:55:09');
...
(4, 'Rumah Tangga', 3000.00, 10000.00),
(5, 'Industri', 4500.00, 20000.00),
(6, 'instansi pemerintah', 7000.00, 15000.00);
...
(16, 'alya', 'alya123', 'alya martaza', 'pelanggan', 2, '2026-06-06 14:09:33');
